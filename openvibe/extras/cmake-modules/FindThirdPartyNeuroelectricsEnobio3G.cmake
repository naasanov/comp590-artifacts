...
IF(WIN32)
  	FIND_PATH(PATH_ENOBIOAPI enobio3g.h)
	IF(NOT PATH_ENOBIOAPI)
		OV_PRINT(OV_PRINTED "  FAILED to find ENOBIO API (optional driver), skipping Enobio.")
		RETURN()
	ENDIF(NOT PATH_ENOBIOAPI)
	
	OV_PRINT(OV_PRINTED "  Found ENOBIO API...")

	FIND_LIBRARY(LIB_ENOBIOAPI Enobio3GAPI)
