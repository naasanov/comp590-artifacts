...
IF(WIN32)
	IF("${PLATFORM_TARGET}" STREQUAL "x64")
			OV_PRINT(OV_PRINTED "  SKIPPED Emotiv EPOC not yet supported on 64bit builds...")
...
FIND_PATH(PATH_EmotivAPI1 edk.h PATHS ${PATH_Candidates})
IF(PATH_EmotivAPI1)
...
FIND_PATH(PATH_EmotivAPI2 IEdk.h PATHS ${PATH_Candidates})
IF(PATH_EmotivAPI2)
...
FIND_PATH(PATH_EmotivAPI3 IEegData.h PATHS ${PATH_Candidates})
IF(PATH_EmotivAPI3)
